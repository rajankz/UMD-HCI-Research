...
public class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void loadKeyboard(EditorInfo editorInfo, SettingsValues settingsValues) {
        ...
        //hackhack: telling which keyboard layout to load
        mKeyboardLayoutSet = builder.build(mPrefs.getBoolean("alternateKeyboardPref", true));
    ...
    public void setAlphabetKeyboard() {
        if(mKeyboardView.isAlternateKeyboardEnabled())
            setKeyboard(mKeyboardLayoutSet.getKeyboard(KeyboardId.ELEMENT_ALPHABET));
        else
            setKeyboard(mKeyboardLayoutSet.getKeyboard(KeyboardId.ELEMENT_ONLY_ALPHABET));
    }
