...
public class KeyboardLayoutSet {
    ...
    public static class Builder {
        ...
        public KeyboardLayoutSet build(boolean defaultKbd) {
            ...
            //hackhack: pass our layout if not in default mode
            final String packageName = mResources.getResourcePackageName(
                    defaultKbd?R.xml.keyboard_layout_set_qwerty:R.xml.keyboard_layout_set_simple_qwerty);
            if(!defaultKbd && mParams.mKeyboardLayoutSetName.equals("keyboard_layout_set_qwerty"))
                mParams.mKeyboardLayoutSetName = "keyboard_layout_set_simple_qwerty" ;
