...
public class SettingsValues {
    ...
    public final boolean mGestureEnabled;
    public final boolean mAlternateKeyboardEnabled;
    ...
    public SettingsValues(final SharedPreferences prefs, final Context context) {
        ...
        mGestureEnabled = prefs.getBoolean(Settings.PREF_GESTURE_ENABLED, false);
        mAlternateKeyboardEnabled = prefs.getBoolean(Settings.PREF_ALTERNATE_KEYBOARD_ENABLED, true);
